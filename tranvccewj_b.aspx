		...
		<div  id="dbbs"  >
			<table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:White; background:#003366;' >
					...
					<th align="center"><a id=''>派車編號</a></th>
				...
				<tr  style='background:#cad3ff;'>
					...
					<td style="width:120px;"><input id="txtConn.*" type="text" style="float:left;width:95%;" readonly="readonly"/></td>
					...
					<td style="width:90px;">
                        <input id="txtBdate.*" type="text" style="float:left;width:95%;" readonly="readonly" />
                    </td>
                    <td style="width:90px;">
                        <input id="txtEdate.*" type="text" style="float:left;width:95%;" readonly="readonly" />
                    </td>
					
					<td style="width:90px;"><input id="txtWeight.*" type="text" style="text-align:right;width:95%;" readonly="readonly"/></td>
					<td style="width:70px;"><input id="txtMount.*" type="text" style="text-align:right;width:95%;" readonly="readonly"/></td>
					<td style="width:70px;"><input id="txtUnit.*" type="text" style="text-align:right;width:95%;" readonly="readonly"/></td>
					<td style="width:100px;">
					...
					<td style="width:100px;">
                        ...
                        <input id="txtAddress2.*" type="text" style="display:none;" />
                    </td>
